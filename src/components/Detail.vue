...
<template>
  <div class="container-fluid">
    <div class="row pets mb-5">
      <div class="col">
        <h1 class="m-3">
          Kasutaja <b>{{ userId }}</b> lemmikloomad
        </h1>
        <div class="add my-3 h3">
          <router-link :to="{ name: 'NewPet', params: { userId: userId } }"
            >Lisa uus lemmik</router-link
          >
        </div>
      </div>
    </div>
    ...
    <div class="project-container">
      <div class="row project" v-for="pets in petsFromServer" :key="pets">
        ...
        <div class="col-6 d-block m-auto">
          <div class="textbox">
            <div class="project__text">
              ...
              <li>
                Lemmiku välimus: <b>{{ pets.v2limus }}</b>
              </li>
              <li>
              ...
              <div class="col-6">
                <button class="btn mx-5 p-3 mb-5">
                  <router-link
                    ...
                    >Muuda lemmiklooma infot</router-link
                  >
                </button>
              </div>
              <div class="col-6">
